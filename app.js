...
(function () {
  ...
  // ---- VALID ACCESS CODES ----
  const VALID_CODES = ["NETER-SEI-4411", "OSIIRE-DRAGON-2026", "PAPYRUS-SACRE-777", "PAPYRUS-SYLVIE-AVR26", "PAPYRUS-OMAIDA-AVR26", "PAPYRUS-NADIA-AVR26", "PAPYRUS-TITAYANA-AVR26", "PAPYRUS-SYLVIE-MAI26", "PAPYRUS-OMAIDA-MAI26", "PAPYRUS-NADIA-MAI26", "PAPYRUS-TITAYANA-MAI26", "PAPYRUS-SYLVIE-JUN26", "PAPYRUS-OMAIDA-JUN26", "PAPYRUS-NADIA-JUN26", "PAPYRUS-TITAYANA-JUN26"];
  // ---- PLAN CONFIGURATION ----
  const PLAN_DRAWS = {
    single: 1,
    triple: 3,
